...
df_facturas = extraerFacturas(df_dataC)
...
def clasificar(df):
    ...
    df_normalizadaC["NUMERO_FACTURA_1111"] = df_normalizadaC["NUMERO_FACTURA"].str[-2:].apply(es_digito)
